    ...
    return (
        <div>
            ...
            <input type={type} id={name} name={name} placeholder={placeholder} value={value} onChange={handleChange} required 
                className='bg-[#f7f7ff] border border-[#279af1] text-gray-900 text-sm rounded-lg focus:ring-[#279af1] focus:border-[#49beaa] text-ellipsis outline-none block w-full h-10 p-3' />
